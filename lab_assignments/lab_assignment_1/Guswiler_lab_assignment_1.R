...
frog_data <- read.csv("lab_assignments/lab_assignment_1/frog_ponds.csv")
...
NLCD <- rast("lab_assignments/lab_assignment_1/frog_ponds_NLCD.tif")
DEM <- rast("lab_assignments/lab_assignment_1/frog_ponds_DEM.tif")
