...
becky_data <- read.csv("lab/week_2/becky.csv")
...
upland <- rast("lab/week_2/becky_Upland_100.tif")
upland
...
land_cover <- rast(c("lab/week_2/becky_Upland_100.tif",      # Undeveloped upland land cover
                     "lab/week_2/becky_Urban_100.tif",       # Urban land cover
                     "lab/week_2/becky_Wetlands_100.tif",    # Wetland land cover
                     "lab/week_2/becky_Win_SDNDVI_100.tif")) # SD of winter NDVI within a 100-m radius buffer
