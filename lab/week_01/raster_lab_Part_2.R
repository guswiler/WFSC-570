...
file_paths <- "lab/week_1/NLCD_2021_Maricopa_for_lab.tif"
...
DEM <- rast("lab/week_1/DEM_Maricopa.tif") 
...
output_raster_path <- "lab/week_1/outputs/FOREST_and_DEM.tif"
...
file.exists("lab/week_1/outputs/FOREST_and_DEM.tif")
